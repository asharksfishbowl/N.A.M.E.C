...
| Souls-like combat | Stamina-gated attacks, dodge rolls with invulnerability frames, blocking, parrying, poise, lock-on and multi-phase bosses. |
...
- No NPCs, towns, vendors, or currency (no gold).
- No story campaign or quest system beyond boss progression.
- No enemy raids on player bases.
